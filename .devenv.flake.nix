{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/hambergerpls/.config/nvim";
  project_input_ref = "path:/home/hambergerpls/.config/nvim";
  devenv_dotfile = "/home/hambergerpls/.config/nvim/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-5b06a9f";
  devenv_istesting = false;
  devenv_direnvrc_latest_version = 1;
  container_name = null;
  active_profiles = [
  ];
  hostname = "portableTARDIS";
  username = "hambergerpls";
  git_root = "/home/hambergerpls/.config/nvim";
  secretspec = null;
};
    in
    {
